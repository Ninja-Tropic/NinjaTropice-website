...
/**
 * Register ACF field group for Projects CPT
 */
function ninjatheme_register_project_fields() {
	if ( ! function_exists( 'acf_add_local_field_group' ) ) {
		return;
	}

	acf_add_local_field_group( array(
		'key'                   => 'group_ninjatheme_project',
		...
		'fields'                => array(
			array(
				...
				'name'         => 'project_video',
				'type'         => 'url',
				'instructions' => 'YouTube or Vimeo URL for the main project video.',
				'required'     => 0,
				'wrapper'      => array( 'width' => '100', 'class' => '', 'id' => '' ),
			),
			array(
				'key'          => 'field_project_industry',
				'label'        => 'Industry',
				'name'         => 'project_industry',
				'type'         => 'text',
				'instructions' => 'e.g. Medical, Retail, Finance',
				'required'     => 0,
				'wrapper'      => array( 'width' => '33', 'class' => '', 'id' => '' ),
			),
			array(
				'key'          => 'field_project_main_goal',
				'label'        => 'Main Goal',
				'name'         => 'project_main_goal',
				'type'         => 'textarea',
				'instructions' => 'e.g. Rising awareness on genetic studies',
				'required'     => 0,
				'rows'         => 3,
				'new_lines'    => 'br',
				'wrapper'      => array( 'width' => '33', 'class' => '', 'id' => '' ),
			...
			array(
				'key'          => 'field_project_animation_style',
				'label'        => 'Animation Style',
				'name'         => 'project_animation_style',
				'type'         => 'text',
				'instructions' => 'e.g. Motion Graphic, 2D Animation',
				'required'     => 0,
				'wrapper'      => array( 'width' => '33', 'class' => '', 'id' => '' ),
			),
			array(
				'key'          => 'field_project_training_topic',
				'label'        => 'Training Topic',
				'name'         => 'project_training_topic',
				'type'         => 'textarea',
				'instructions' => 'e.g. Customer Education / Healthcare Training',
				'required'     => 0,
				'rows'         => 3,
				'new_lines'    => 'br',
				'wrapper'      => array( 'width' => '33', 'class' => '', 'id' => '' ),
			...
			array(
				'key'          => 'field_project_art_style',
				'label'        => 'Art Style',
				'name'         => 'project_art_style',
				'type'         => 'text',
				'instructions' => 'e.g. Comic Book / Friendly, Flat Design',
				'required'     => 0,
				'wrapper'      => array( 'width' => '33', 'class' => '', 'id' => '' ),
			),
		),
...
add_action( 'acf/init', 'ninjatheme_register_project_fields' );
